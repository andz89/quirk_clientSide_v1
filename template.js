...
log(){
  ...
  log.onclick = () =>{
    ...
    console.log(` log  ` + obj.getScaledWidth())
  }
}
crop(){
  ...
  const lock_image = (object, bollean)=>{
    ...
    test_crop_btn.onclick = () => {
      let image_display =  this.canvas.getActiveObject()
      image_display.orginal_top = image_display.top
     image_display.orginal_left = image_display.left
     image_display.orginal_image = image_display._originalElement.currentSrc
     image_display.orginal_width = image_display.getScaledWidth()
     image_display.orginal_height = image_display.getScaledHeight()
    ...
    image_object = this.canvas.getActiveObject()
      ...
      if(image_object.original_image !== undefined){
        ...
        img.left = image_object.left + b_left;
        img.width = image_object.original_image_width;
        img.height = image_object.original_image_height;
        img.scaleX = image_object.original_image_scaleX;
        img.scaleY = image_object.original_image_scaleY;
        ...
        this.canvas.bringToFront(cropper_box)
        image_object = img
      ...
      image_object.scaleToWidth(this.canvas.width * .30)
      image_object.scaleToHeight(this.canvas.height * .30)
    ...
    //create box cropper
      ...
      let dark_background = new fabric.Rect({
        ...
        fabric.Image.fromURL(b, (img)=>{
          ...
          img.left = image_display.orginal_left,
          img.top = image_display.orginal_top
          ...
          img.scaleToWidth(this.canvas.width * .30)
          img.scaleToHeight(this.canvas.height * .30)
        });
      ...
      document.querySelector('.save_cancel_crop #cancel').onclick = ()=>{
          ...
          buttons.forEach((e)=>{
            ...
            this.canvas.remove(image_object)
            fabric.Image.fromURL( image_display.orginal_image, (img)=>{
            img.left = image_display.orginal_left,
            img.top = image_display.orginal_top,
